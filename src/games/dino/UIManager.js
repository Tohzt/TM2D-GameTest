...
export class UIManager {
	constructor(scene) {
		...
		this.highScore = parseInt(
			localStorage.getItem("dinoRunnerHighScore") || "0"
		);
	...
	createGameUI() {
		...
		this.scoreText.setDepth(DINO_CONFIG.UI_DEPTH);
		...
		this.highScoreText.setDepth(DINO_CONFIG.UI_DEPTH);
		...
		this.startText = this.scene.add
			...
			.setOrigin(0.5);
		this.startText.setDepth(DINO_CONFIG.UI_DEPTH);
	}
	...
	showGameOver(score) {
		...
		const titleText = this.scene.add
			...
			.setOrigin(0.5);
		titleText.setDepth(DINO_CONFIG.UI_DEPTH);
		...
		const scoreText = this.scene.add
			...
			.setOrigin(0.5);
		scoreText.setDepth(DINO_CONFIG.UI_DEPTH);
		...
		retryText.setDepth(DINO_CONFIG.UI_DEPTH);
		...
		const quitText = this.scene.add
			...
			.setOrigin(0.5)
			.setInteractive({ useHandCursor: true });
		quitText.setDepth(DINO_CONFIG.UI_DEPTH);
